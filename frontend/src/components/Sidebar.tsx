...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-64 bg-[#0f0f1e] border-r border-gray-800 flex-col z-40">
      {/* Logo */}
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all relative ${
            isActive('/likes') ? 'text-purple-400' : 'text-gray-400 hover:text-white'
          }`}
        >
          {isActive('/likes') && (
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-10 bg-purple-500 rounded-r-full"></div>
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all relative ${
            isActive('/settings') ? 'text-purple-400' : 'text-gray-400 hover:text-white'
          }`}
        >
          {isActive('/settings') && (
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-10 bg-purple-500 rounded-r-full"></div>
