  ...
  if (users.length === 0) {
    return (
      <>
        ...
        <div className="min-h-screen bg-[#0a0a1f] pt-16 lg:pt-20 pb-20 lg:pb-6">
          <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 pt-4 lg:pt-8 pb-6 sm:pb-10">
            <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr_340px] xl:grid-cols-[260px_1fr_360px] gap-6 items-start">
                  ...
                  {currentUser.photoUrl ? (
                    <div className="relative">
                      {currentUser.mediaType === 'video' ? (
                        // Show actual video player for intro video
                        <video
                          src={currentUser.photoUrl}
                          className="w-full h-[550px] sm:h-[600px] md:h-[650px] lg:h-[700px] object-cover"
                          controls
                          autoPlay
                          muted
                          loop
